 ...
 */
package com.dorck.android.tracker.os;
...
public class Sysconf {
    ...
    /**
     * sysconf(_SC_CLK_TCK)是一个系统调用，用于返回每秒的时钟滴答数，也可以称为系统时钟频率。
     *
     * 它是在POSIX标准中定义的一个宏常量，用于获取系统时钟所需的时钟滴答数。
     * 除非系统时钟速度发生了变化，否则该值在整个操作系统中保持不变。
     * 可以根据此值计算进程的CPU使用时间以及其他与时间有关的操作。
     */
